...
var MAT_SLIDE_TOGGLE_DEFAULT_OPTIONS = new InjectionToken(
...
_MatSlideToggle.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatSlideToggle_HostBindings(rf, ctx) {
    if (rf & 2) {
      ...
      ɵɵattribute("tabindex", null)("aria-label", null)("name", null)(
        "aria-labelledby",
        null,
      );
      ɵɵclassMap(ctx.color ? "mat-" + ctx.color : "");
      ɵɵclassProp("mat-mdc-slide-toggle-focused", ctx._focused)(
  ...
  template: function MatSlideToggle_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵlistener(
        "click",
        function MatSlideToggle_Template_label_click_11_listener($event) {
          ɵɵrestoreView(_r1);
    ...
    if (rf & 2) {
      ...
      ɵɵadvance();
      ɵɵclassProp("mdc-switch--selected", ctx.checked)(
        "mdc-switch--unselected",
        !ctx.checked,
      )("mdc-switch--checked", ctx.checked)(
        "mdc-switch--disabled",
        ctx.disabled,
      );
      ɵɵproperty("tabIndex", ctx.disabled ? -1 : ctx.tabIndex)(
        "disabled",
        ctx.disabled,
      );
      ɵɵattribute("id", ctx.buttonId)("name", ctx.name)(
        "aria-label",
        ctx.ariaLabel,
      )("aria-labelledby", ctx._getAriaLabelledBy())(
        "aria-describedby",
        ctx.ariaDescribedby,
      )("aria-required", ctx.required || null)("aria-checked", ctx.checked);
      ɵɵadvance(8);
      ɵɵproperty("matRippleTrigger", switch_r2)(
        "matRippleDisabled",
...
_MatSlideToggleRequiredValidator.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function MatSlideToggleRequiredValidator_Factory(t) {
    return (
      ...
      (ɵMatSlideToggleRequiredValidator_BaseFactory = ɵɵgetInheritedFactory(
        _MatSlideToggleRequiredValidator,
      ))
    )(t || _MatSlideToggleRequiredValidator);
  };
})();
_MatSlideToggleRequiredValidator.ɵdir = ɵɵdefineDirective({
  ...
  standalone: true,
  features: [
    ɵɵProvidersFeature([MAT_SLIDE_TOGGLE_REQUIRED_VALIDATOR]),
    ɵɵInheritDefinitionFeature,
  ],
});
...
__MatSlideToggleRequiredValidatorModule.ɵfac =
...
var _MatSlideToggleRequiredValidatorModule =
  __MatSlideToggleRequiredValidatorModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) &&
    setClassMetadata(
