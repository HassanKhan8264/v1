...
import { AriaDescriber, FocusMonitor } from "./chunk-JR5M4PHK.js";
import { ENTER, SPACE } from "./chunk-237XUEJ5.js";
...
import { ReplaySubject, Subject, merge } from "./chunk-SXIXOCJ4.js";
...
function MatSortHeader_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      "@arrowPosition.start",
      function MatSortHeader_Conditional_3_Template_div_animation_arrowPosition_start_0_listener() {
        ɵɵrestoreView(_r1);
      ...
      "@arrowPosition.done",
      function MatSortHeader_Conditional_3_Template_div_animation_arrowPosition_done_0_listener() {
        ɵɵrestoreView(_r1);
        const ctx_r1 = ɵɵnextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("@arrowOpacity", ctx_r1._getArrowViewState())(
      "@arrowPosition",
      ctx_r1._getArrowViewState(),
    )("@allowChildren", ctx_r1._getArrowDirectionState());
    ɵɵadvance(2);
...
var _MatSortHeader = class _MatSortHeader {
  ...
  ngOnInit() {
    ...
    this._sortButton = this._elementRef.nativeElement.querySelector(
...
_MatSortHeader.ɵfac = function MatSortHeader_Factory(t) {
  return new (t || _MatSortHeader)(
    ɵɵdirectiveInject(MatSortHeaderIntl),
    ɵɵdirectiveInject(ChangeDetectorRef),
    ɵɵdirectiveInject(MatSort, 8),
    ɵɵdirectiveInject("MAT_SORT_HEADER_COLUMN_DEF", 8),
    ɵɵdirectiveInject(FocusMonitor),
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(AriaDescriber, 8),
    ɵɵdirectiveInject(MAT_SORT_DEFAULT_OPTIONS, 8),
  );
};
_MatSortHeader.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatSortHeader_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵattribute("tabindex", ctx._isDisabled() ? null : 0)(
        "role",
        ctx._isDisabled() ? null : "button",
      );
      ɵɵadvance(3);
