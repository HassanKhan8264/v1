...
function createInvalidObservableTypeError(input2) {
  return new TypeError(
    "You provided " +
      (input2 !== null && typeof input2 === "object"
        ? "an invalid object"
        : "'" + input2 + "'") +
...
function isIterable(input2) {
  return isFunction(
    input2 === null || input2 === void 0 ? void 0 : input2[iterator],
  );
}
...
function scheduleReadableStreamLike(input2, scheduler) {
  return scheduleAsyncIterable(
    readableStreamLikeToAsyncGenerator(input2),
    scheduler,
  );
}
...
var setInjectorProfiler = (injectorProfiler2) => {
  !ngDevMode &&
    throwError2(
      "setInjectorProfiler should never be called in production mode",
    );
  injectorProfilerCallback = injectorProfiler2;
};
function injectorProfiler(event) {
  !ngDevMode &&
    throwError2("Injector profiler should never be called in production mode");
...
var OPTIONAL_END_TAG_ELEMENTS = merge3(
...
var EnvironmentNgModuleRefAdapter = class extends NgModuleRef$1 {
  constructor(config2) {
    ...
    const injector = new R3Injector(
      ...
      config2.parent || getNullInjector(),
      config2.debugName,
      /* @__PURE__ */ new Set(["environment"]),
    );
    this.injector = injector;
...
function wrapListener(
  ...
  return function wrapListenerIn_markDirtyAndPreventDefault(e) {
    ...
    while (nextListenerFn) {
      result =
        executeListenerWithErrorHandling(lView, context2, nextListenerFn, e) &&
        result;
...
function getMultipleMatchingPipesMessage(name) {
  ...
  const componentInfoMessage = context2
    ? ` in the '${context2.constructor.name}' component`
    : "";
...
function patchComponentDefWithScope(componentDef, transitiveScopes) {
  ...
  componentDef.pipeDefs = () =>
    Array.from(transitiveScopes.compilation.pipes).map((pipe2) =>
      getPipeDef$1(pipe2),
    );
...
function handleInjectEvent(context2, data) {
  ...
  assertDefined(
    context2.token,
    "Injector profiler context token is undefined.",
  );
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-LBXCMUWC.js.map
