...
var MAT_PROGRESS_BAR_DEFAULT_OPTIONS = new InjectionToken(
  "MAT_PROGRESS_BAR_DEFAULT_OPTIONS",
);
var MAT_PROGRESS_BAR_LOCATION = new InjectionToken(
...
_MatProgressBar.ɵfac = function MatProgressBar_Factory(t) {
  return new (t || _MatProgressBar)(
    ...
    ɵɵdirectiveInject(MAT_PROGRESS_BAR_DEFAULT_OPTIONS, 8),
  );
};
_MatProgressBar.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatProgressBar_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("aria-valuenow", ctx._isIndeterminate() ? null : ctx.value)(
        "mode",
        ctx.mode,
      );
          ...
          args: [
            {
              ...
              host: {
                ...
                "[class.mdc-linear-progress--animation-ready]":
                  "!_isNoopAnimation",
                "[class.mdc-linear-progress--indeterminate]":
                  "_isIndeterminate()",
              },
