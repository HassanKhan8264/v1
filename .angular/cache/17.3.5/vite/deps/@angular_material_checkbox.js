...
var _c1 = ["label"];
var _c2 = ["*"];
var MAT_CHECKBOX_DEFAULT_OPTIONS = new InjectionToken(
...
(function (TransitionCheckState2) {
  ...
  TransitionCheckState2[(TransitionCheckState2["Indeterminate"] = 3)] =
    "Indeterminate";
...
var _MatCheckbox = class _MatCheckbox {
  ...
  _preventBubblingFromLabel(event) {
    if (
      !!event.target &&
      this._labelElement.nativeElement.contains(event.target)
    ) {
      event.stopPropagation();
    }
  }
...
_MatCheckbox.ɵfac = function MatCheckbox_Factory(t) {
  return new (t || _MatCheckbox)(
    ...
    ɵɵdirectiveInject(MAT_CHECKBOX_DEFAULT_OPTIONS, 8),
  );
};
_MatCheckbox.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatCheckbox_HostBindings(rf, ctx) {
    if (rf & 2) {
      ...
      )("mdc-checkbox--disabled", ctx.disabled)(
        "mat-mdc-checkbox-disabled",
        ctx.disabled,
      )("mat-mdc-checkbox-checked", ctx.checked);
    }
  },
  inputs: {
  ...
  template: function MatCheckbox_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵlistener(
        "click",
        function MatCheckbox_Template_div_click_0_listener($event) {
          ɵɵrestoreView(_r1);
      ...
      ɵɵlistener("blur", function MatCheckbox_Template_input_blur_4_listener() {
        ...
        "change",
        function MatCheckbox_Template_input_change_4_listener($event) {
          ɵɵrestoreView(_r1);
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("checked", ctx.checked)("indeterminate", ctx.indeterminate)(
        "disabled",
        ctx.disabled,
      )("id", ctx.inputId)("required", ctx.required)(
        "tabIndex",
      ...
      ɵɵattribute("aria-label", ctx.ariaLabel || null)(
        ...
        "aria-checked",
        ctx.indeterminate ? "mixed" : null,
      )("name", ctx.name)("value", ctx.value);
      ɵɵadvance(7);
      ɵɵproperty("matRippleTrigger", checkbox_r2)(
        "matRippleDisabled",
...
_MatCheckboxRequiredValidator.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function MatCheckboxRequiredValidator_Factory(t) {
    return (
      ɵMatCheckboxRequiredValidator_BaseFactory ||
      (ɵMatCheckboxRequiredValidator_BaseFactory = ɵɵgetInheritedFactory(
        _MatCheckboxRequiredValidator,
      ))
    )(t || _MatCheckboxRequiredValidator);
  };
})();
_MatCheckboxRequiredValidator.ɵdir = ɵɵdefineDirective({
  ...
  standalone: true,
  features: [
    ɵɵProvidersFeature([MAT_CHECKBOX_REQUIRED_VALIDATOR]),
    ɵɵInheritDefinitionFeature,
  ],
});
...
__MatCheckboxRequiredValidatorModule.ɵfac =
  function _MatCheckboxRequiredValidatorModule_Factory(t) {
