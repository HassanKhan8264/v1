...
import { DOCUMENT, Location } from "./chunk-NKF7BGZJ.js";
import {
...
_CdkDialogContainer.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function CdkDialogContainer_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("id", ctx._config.id || null)("role", ctx._config.role)(
        "aria-modal",
        ctx._config.ariaModal,
      )(
        "aria-labelledby",
...
var _Dialog = class _Dialog {
  ...
  constructor(
    ...
    this.afterAllClosed = defer(() =>
      this.openDialogs.length
        ...
        : this._getAfterAllClosed().pipe(startWith(void 0)),
    );
  ...
  open(componentOrTemplateRef, config) {
    ...
    const dialogContainer = this._attachContainer(
      overlayRef,
      dialogRef,
      config,
    );
...
_Dialog.ɵfac = function Dialog_Factory(t) {
  return new (t || _Dialog)(
    ɵɵinject(Overlay),
    ɵɵinject(Injector),
    ɵɵinject(DEFAULT_DIALOG_CONFIG, 8),
    ɵɵinject(_Dialog, 12),
...
_MatDialogContainer.ɵfac = function MatDialogContainer_Factory(t) {
  return new (t || _MatDialogContainer)(
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(FocusTrapFactory),
    ɵɵdirectiveInject(DOCUMENT, 8),
...
_MatDialogContainer.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatDialogContainer_HostBindings(rf, ctx) {
    if (rf & 2) {
      ...
      ɵɵattribute("aria-modal", ctx._config.ariaModal)(
        "role",
        ctx._config.role,
      )(
        "aria-labelledby",
...
var MAT_DIALOG_DEFAULT_OPTIONS = new InjectionToken(
  "mat-mdc-dialog-default-options",
);
var MAT_DIALOG_SCROLL_STRATEGY = new InjectionToken(
...
var _MatDialog = class _MatDialog {
  ...
  open(componentOrTemplateRef, config) {
    ...
    config = __spreadValues(
      __spreadValues({}, this._defaultOptions || new MatDialogConfig()),
      config,
    );
    config.id = config.id || `mat-mdc-dialog-${uniqueId2++}`;
    config.scrollStrategy = config.scrollStrategy || this._scrollStrategy();
    const cdkRef = this._dialog.open(
      componentOrTemplateRef,
...
_MatDialog.ɵfac = function MatDialog_Factory(t) {
  return new (t || _MatDialog)(
    ɵɵinject(Overlay),
    ɵɵinject(Injector),
    ɵɵinject(Location, 8),
    ɵɵinject(MAT_DIALOG_DEFAULT_OPTIONS, 8),
    ɵɵinject(MAT_DIALOG_SCROLL_STRATEGY),
    ɵɵinject(_MatDialog, 12),
    ɵɵinject(OverlayContainer),
...
_MatDialogClose.ɵfac = function MatDialogClose_Factory(t) {
  return new (t || _MatDialogClose)(
    ɵɵdirectiveInject(MatDialogRef, 8),
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(MatDialog),
  );
};
...
_MatDialogLayoutSection.ɵfac = function MatDialogLayoutSection_Factory(t) {
  return new (t || _MatDialogLayoutSection)(
    ɵɵdirectiveInject(MatDialogRef, 8),
    ɵɵdirectiveInject(ElementRef),
    ɵɵdirectiveInject(MatDialog),
  );
...
_MatDialogTitle.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function MatDialogTitle_Factory(t) {
    return (
      ...
      (ɵMatDialogTitle_BaseFactory = ɵɵgetInheritedFactory(_MatDialogTitle))
    )(t || _MatDialogTitle);
  };
})();
...
_MatDialogActions.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function MatDialogActions_Factory(t) {
    return (
      ...
      (ɵMatDialogActions_BaseFactory = ɵɵgetInheritedFactory(_MatDialogActions))
    )(t || _MatDialogActions);
  };
})();
_MatDialogActions.ɵdir = ɵɵdefineDirective({
  ...
  hostBindings: function MatDialogActions_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mat-mdc-dialog-actions-align-start", ctx.align === "start")(
        "mat-mdc-dialog-actions-align-center",
        ctx.align === "center",
      )("mat-mdc-dialog-actions-align-end", ctx.align === "end");
    }
  },
  inputs: {
    align: "align",
